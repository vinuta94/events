...
<html lang="en">
<head>
<title>Event Management Website  | Home :: W3layouts</title>

<!-- Meta tag Keywords -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Travel Buzz  web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template, Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<div class="sub-agile">
		<div class="col-md-4 agile1">
				...
				<div class="overlay overlay-boxes">
					...
					<nav>
						<ul>
							...
							<li><a href="event.php" class="scroll">Add Event</a></li>
			...
			<div class="col-md-4 logo">
				<h1><a href="index.php">Event Buzz</a></h1>
				</div>
								...
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal">&times;</button>
											...
											<span>Lorem ipsum dolor sit amet, Sed ut perspiciatis unde omnis iste natus error sit voluptatem , 
												eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.accusantium doloremque laudantium, t
												otam rem aperiamconsectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</span>
									</div>
								</div>
...
<div class="w3-event" id="event">
	<div class="container">
		...
		<?php
    require('dbConnect.php');//connect to config file
        ...
        while ($row=mysqli_fetch_assoc($result))
            {
				...
				$seat=$row['seats_ava'];
                $mobile1=$row['contact1'];
                $mobile2=$row['contact2'];
	...
	<div class="w3-events-grid">	
		<div class="w3-event-grids-top">
				...
				<div class="col-md-6 w3-event-right">
					...
					<a href="fetch.php?id=<?php echo $id;?>">More Details</a>
				</div>
				<div class="clearfix"></div>
			</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="copy-right">
				<p>© 2017 Travel Buzz. All rights reserved | Design by <a href="http://w3layouts.com">W3layouts</a></p>
			</div>
		</div>
	</div>
<!-- //footer --> 
